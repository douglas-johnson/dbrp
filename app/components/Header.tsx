          ...
          return (
            <li key={item.id}>
              <NavLink
                ...
                prefetch="intent"
                to={url}
                onClick={() => useableNavContext?.menu?.current?.close()}
              >
                {item.title}
              </NavLink>
            </li>
  ...
  return (
    ...
    >
      <svg
        ...
        height="24"
      >
        <path d="M19.6,21l-6.3-6.3c-.5.4-1.08.72-1.73.95s-1.34.35-2.08.35c-1.82,0-3.35-.63-4.61-1.89s-1.89-2.8-1.89-4.61.63-3.35,1.89-4.61,2.8-1.89,4.61-1.89,3.35.63,4.61,1.89,1.89,2.8,1.89,4.61c0,.73-.12,1.43-.35,2.08s-.55,1.23-.95,1.73l6.3,6.3-1.4,1.4ZM9.5,14c1.25,0,2.31-.44,3.19-1.31s1.31-1.94,1.31-3.19-.44-2.31-1.31-3.19-1.94-1.31-3.19-1.31-2.31.44-3.19,1.31-1.31,1.94-1.31,3.19.44,2.31,1.31,3.19,1.94,1.31,3.19,1.31Z" />
      </svg>
    </Button>
  );
}
  ...
  return (
    ...
    >
      <svg
        ...
        height="24"
      >
        <path d="M8.01,22c-.55,0-1.02-.2-1.41-.59s-.59-.86-.59-1.41.2-1.02.59-1.41.86-.59,1.41-.59,1.02.2,1.41.59.59.86.59,1.41-.2,1.02-.59,1.41-.86.59-1.41.59ZM18.01,22c-.55,0-1.02-.2-1.41-.59s-.59-.86-.59-1.41.2-1.02.59-1.41.86-.59,1.41-.59,1.02.2,1.41.59.59.86.59,1.41-.2,1.02-.59,1.41-.86.59-1.41.59ZM7.16,6l2.4,5h7l2.75-5H7.16ZM6.21,4h14.75c.38,0,.68.17.88.51s.21.69.03,1.04l-3.55,6.4c-.18.33-.43.59-.74.78s-.65.28-1.01.28h-7.45l-1.1,2h12v2h-12c-.75,0-1.32-.33-1.7-.99s-.4-1.31-.05-1.96l1.35-2.45-3.6-7.6h-2V2h3.25l.95,2ZM9.56,11h7-7Z" />
      </svg>
    </Button>
  );
}
